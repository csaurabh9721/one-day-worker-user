...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(DuplicateRequestContentException.class)
    public ResponseEntity<ApiResponse<String>> handleDuplicateRequest(DuplicateRequestContentException ex) {
